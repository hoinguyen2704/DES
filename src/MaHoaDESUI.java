...
public class MaHoaDESUI extends JFrame {
    ...
    private void initComponents() {
        ...
        btnEncEncryptFile.addActionListener(e -> {
            ...
            try {
                ...
                // Cắt thành các block 16 ký tự hex
                ...
                taEncPlainFile.setText(fileHex);
                taEncResultText.setText(encryptedHexBuilder.toString());
                ...
                try (java.io.FileWriter fw = new java.io.FileWriter(outFile)) {
                    fw.write(encryptedHexBuilder.toString());
                }
                JOptionPane.showMessageDialog(this, "Đã mã hóa và lưu file: " + outFile.getAbsolutePath());
            } catch (Exception ex) {
        ...
        btnDecDecryptFile.addActionListener(e -> {
            ...
            try {
                ...
                taDecResultText.setText(decryptedHexBuilder.toString());
                ...
                java.io.File outFile = new java.io.File(inputFile.getParentFile(), outName);
                try (java.io.FileWriter fw = new java.io.FileWriter(outFile)) {
                    fw.write(decryptedHexBuilder.toString());
                }
    ...
    private void maHoaVanBan() {
        String plaintext = taEncPlainFile.getText().toUpperCase();
        ...
        List<String> blocks = DES.splitHexToBlocks(plaintext);
        StringBuilder encryptedHexBuilder = new StringBuilder();
        for (String block : blocks) {
        ...
        taEncResultText.setText(encryptedHexBuilder.toString());
        JOptionPane.showMessageDialog(this, "Mã hóa thành công");
    }
    ...
    private void giaiMaVanBan() {
        ...
        int[] ciphertextBinary = DES.textToBinary(ciphertext);
        int[] keyBinary = DES.textToBinary(key);
        int[] decryptedBinary = DES.decryptText(ciphertextBinary, keyBinary);
        String decryptedHex = DES.binaryToHex(decryptedBinary);
        taDecResultText.setText(decryptedHex);
        JOptionPane.showMessageDialog(this, "Giải mã Thành Công");
    }
